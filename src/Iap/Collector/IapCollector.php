...
/**
 * Iap data collector - dumps the contents of the `Config` and `ApplicationConfig` services
 */
class IapCollector implements CollectorInterface, Serializable
{
    ...
    {
        $authService = $this->serviceLocator->get('IapService');
        $userDetails = array(
            "firstName" => 'Anonymous',
            'lastName' => 'User',
